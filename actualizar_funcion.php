...
<body>
    ...
    <form class="login100-form validate-form" ACTION=proceso_actualizar_funcion.php METHOD=POST>
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="id_funcion" value="<?php echo $row ['id_funcion'] ?>" readonly>
						<span class="focus-input100"></span>
						<span class="label-input100">ID funcion</span>
					</div>
					
					
					<div class="wrap-input100 validate-input" >
						<input class="input100" type="text" name="fecha" value="<?php echo $row ['fecha'] ?>">
						<span class="focus-input100"></span>
						<span class="label-input100">Fecha </span>
					</div>

                    <div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="hora" value="<?php echo $row ['hora'] ?>">
						<span class="focus-input100"></span>
						<span class="label-input100">Hora</span>
					</div>

                    <div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="teatro" value="<?php echo $row ['teatro'] ?>" readonly>
						<span class="focus-input100"></span>
						<span class="label-input100">Teatro</span>
					</div>
